...
% Define Kotlin language for listings (based on Java)
\lstdefinelanguage{Kotlin}{
    keywords={abstract, actual, as, break, by, catch, class, companion, const, constructor, continue, data, do, else, enum, expect, false, final, finally, for, fun, if, import, in, interface, internal, is, null, object, open, out, override, package, private, protected, public, return, sealed, super, suspend, this, throw, true, try, val, var, when, while},
    morecomment=[l]{//},
    morecomment=[s]{/*}{*/},
    morestring=[b]",
    morestring=[s]{"""}{"""},
...
ShuttleModelTest.kt & Route model data integrity, schedule parsing, DayType enum \\
UserModelTest.kt & User model creation, role validation, default values \\
ConstantsTest.kt & Application constants, Firebase URL, notification channels \\
ErrandModelTest.kt & Errand, ErrandType, ErrandStatus, ErrandBalance models \\
ForumModelTest.kt & ForumPost, ForumComment, ForumCategory models \\
MessageModelTest.kt & Conversation, ChatMessage models, message types \\
BookingModelTest.kt & Booking, BookingStatus models, facility types \\
AttendanceModelTest.kt & Course, DayOfWeek, AttendanceRecord, SignInStatus, CourseType enums \\
