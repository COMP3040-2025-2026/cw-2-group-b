...
Campus Forum & Community discussions with posts, comments, and likes \\
...
|   |-- profileImageUrl, studentId, faculty
...
Push notifications are delivered via Firebase Cloud Messaging (FCM). When a user sends a message, the recipient receives a notification even when the app is in the background. Figure~\ref{fig:messaging} shows the complete messaging flow.
